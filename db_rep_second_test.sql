...
--
-- Table structure for table `playersintounaments`
--

DROP TABLE IF EXISTS `playersintounaments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `playersintounaments` (
  `tournamentid` int(11) NOT NULL,
  `id` int(11) DEFAULT NULL,
  PRIMARY KEY (`tournamentid`),
  KEY `id` (`id`),
  CONSTRAINT `playersintounaments_ibfk_1` FOREIGN KEY (`tournamentid`) REFERENCES `tournamentinfo` (`tournamentid`),
  CONSTRAINT `playersintounaments_ibfk_2` FOREIGN KEY (`id`) REFERENCES `playerinfo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `playersintounaments`
--

LOCK TABLES `playersintounaments` WRITE;
/*!40000 ALTER TABLE `playersintounaments` DISABLE KEYS */;
/*!40000 ALTER TABLE `playersintounaments` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-05-07  4:36:36
